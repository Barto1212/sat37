const Assurance = () => (
	<>
		...
		<ul>
			<li>
				Option A: Responsabilité civile et mortalité par insectiside.
				Cotisation annuelle: 0.045€ par ruche
			</li>
			<li>
				Option B: Responsabilité civile, dommages, vol, incendie, mortalité par insecticide
				Limite de garantie 120€ pour la ruche et son contenu, 
				130€ pour l'essaim et son couvain, 
