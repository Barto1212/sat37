...
const Revues = () => {
  const revues = [
    ...
    },
    {
      ...
      edition:
        'Fédération Nationnale des Organisations Sanitaires Apicoles Départementales',
      prix: 49,
    },
  ]
  return (
    <>
      <p>
        Le SAT 37 vous propose en option un abonnement aux revues apicoles
        suivantes :
      </p>
      <table>
        <tbody>
